 ...
 * @author daiyc
 */
public class InsertSelectiveOrIgnoreJavaMapperMethodGenerator extends AbstractJavaMapperMethodGenerator {
    private static final String METHOD_NAME = "insertOrIgnore";
